...
#' @export
selectVariables <- function(data = NULL, no.variables = 10000,
                            method = "IQR", group = NULL, filter = "none", threads = 1, file.stats = NULL){
